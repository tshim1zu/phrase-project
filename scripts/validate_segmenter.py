...
class LongTextValidator:
    ...
    def load_sample_texts(self) -> Dict[str, str]:
        ...
        example_file = Path(__file__).parent / "examples" / "data" / "text.tsv"
    ...
    def validate_text(self, text: str, text_name: str) -> Dict:
        ...
        try:
            ...
            results['methods']['threshold'] = {
                ...
                'avg_length': float(np.mean([len(s) for s in segments_threshold])),
            }
        ...
        try:
            ...
            results['methods']['topn'] = {
                ...
                'avg_length': float(np.mean([len(s) for s in segments_topn])),
            }
        ...
        try:
            ...
            results['methods']['smart'] = {
                ...
                'avg_length': float(np.mean([len(s) for s in segments_smart])),
            }
        ...
        try:
            ...
            print(f"  ピーク数: {len(analysis['peaks'])}個")
